...
<html>
  ...
  <body>
    ...
    <div id = 'main_div'>
        ...
        <div id = 'main_center'>
          <div class = 'search'>
            <input class = "findSearch"  >
            <button type="submit" class = 'searchButton' onclick = 'search()'></button>
          </div>
        ...
        <div id = 'main_right'>
          ...
          if(session.getAttribute("username") != null) {
            ...
            out.print("<br><a class = 'purchase' href = 'http://localhost:8080/website/purchase'>Корзина</a>");
